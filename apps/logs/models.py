...
class ActivityLog(models.Model):
    ...
    class Action(models.TextChoices):
        ...
        CATEGORY_PURGED = 'category_purged', 'Kateqoriyanı həmişəlik sildi'
        ...
        USER_DELETED = 'user_deleted', 'İstifadəçini həmişəlik sildi'
        USER_PASSWORD_RESET = 'user_password_reset', 'Şifrə sıfırlama göndərdi'
        USER_PASSWORD_CHANGED = 'user_password_changed', 'Öz şifrəsini dəyişdi'
        ...
        AD_PURGED = 'ad_purged', 'Reklam kampaniyasını həmişəlik sildi'
